        ...
        >
          ...
          <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 space-y-6 relative z-10">
              <h1
                className={`text-4xl md:text-6xl font-bold leading-tight transition-all duration-1000 ease-out ${
              ...
              <p
                className={`text-lg text-muted-foreground transition-all duration-1000 ease-out delay-200 ${
                  visibleSections.has("hero")
                    ? "opacity-100 translate-y-0"
              ...
              <div
                className={`flex gap-4 pt-4 transition-all duration-1000 ease-out delay-400 ${
                  visibleSections.has("hero")
              ...
              >
                <Link href="/quiz/new" passHref>
                  <Button
                    size="lg"
                    className="gap-2 backdrop-blur-sm bg-primary/90 hover:bg-primary/80 border border-white/20"
                ...
                <Link href="/categories">
                  <Button
                    size="lg"
                    variant="outline"
                    className="backdrop-blur-sm bg-white/10 hover:bg-white/20 border border-white/30"
                  >
                    Explore Languages
                  </Button>
                </Link>
            ...
            <div
              className={`md:w-1/2 relative z-10 transition-all duration-1200 ease-out delay-300 ${
                visibleSections.has("hero")
                  ? "opacity-100 translate-x-0 scale-100"
                  : "opacity-0 translate-x-8 scale-95"
              }`}
            >
              <div className="relative w-full h-[400px] bg-gradient-to-br from-primary/20 to-accent/20 rounded-2xl overflow-hidden backdrop-blur-md border border-white/20 shadow-2xl">
                <div
